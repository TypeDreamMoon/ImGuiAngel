...
static void RegisterImGuiBinds()
{
	...
	FAngelscriptBinds::BindGlobalFunction("void SameLine(float32 OffsetFromStartX = 0.0f, float32 Spacing = -1.0f)", FUNC_TRIVIAL(ImGuiWrappers::SameLine));
	...
	FAngelscriptBinds::BindGlobalFunction("void Indent(float32 IndentW = 0.0f)", FUNC_TRIVIAL(ImGuiWrappers::Indent));
	FAngelscriptBinds::BindGlobalFunction("void Unindent(float32 IndentW = 0.0f)", FUNC_TRIVIAL(ImGuiWrappers::Unindent));
	...
	FAngelscriptBinds::BindGlobalFunction("void SetCursorPosX(float32 LocalX)", FUNC_TRIVIAL(ImGuiWrappers::SetCursorPosX));
	FAngelscriptBinds::BindGlobalFunction("void SetCursorPosY(float32 LocalY)", FUNC_TRIVIAL(ImGuiWrappers::SetCursorPosY));
	...
	// Tables
	FAngelscriptBinds::BindGlobalFunction("bool BeginTable(FString StrID, int Columns, int Flags = 0, FVector2D OuterSize = FVector2D(0,0), float32 InnerWidth = 0.0f)", FUNC_TRIVIAL(ImGuiWrappers::BeginTable));
	FAngelscriptBinds::BindGlobalFunction("void EndTable()", FUNC_TRIVIAL(ImGuiWrappers::EndTable));
	FAngelscriptBinds::BindGlobalFunction("void TableNextRow(int RowFlags = 0, float32 MinRowHeight = 0.0f)", FUNC_TRIVIAL(ImGuiWrappers::TableNextRow));
	...
	FAngelscriptBinds::BindGlobalFunction("void TableSetupColumn(FString Label, int Flags = 0, float32 InitWidthOrWeight = 0.0f, int UserId = 0)", FUNC_TRIVIAL(ImGuiWrappers::TableSetupColumn));
	...
	FAngelscriptBinds::BindGlobalFunction("void PushItemWidth(float32 ItemWidth)", FUNC_TRIVIAL(ImGuiWrappers::PushItemWidth));
	FAngelscriptBinds::BindGlobalFunction("void PopItemWidth()", FUNC_TRIVIAL(ImGuiWrappers::PopItemWidth));
	FAngelscriptBinds::BindGlobalFunction("void SetNextItemWidth(float32 ItemWidth)", FUNC_TRIVIAL(ImGuiWrappers::SetNextItemWidth));
