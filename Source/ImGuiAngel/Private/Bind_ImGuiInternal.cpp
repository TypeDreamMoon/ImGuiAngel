...
static void RegisterImGuiInternalBinds()
{
    ...
    FAngelscriptBinds::BindGlobalFunction("uint32 DockBuilderSplitNode(uint32 NodeId, int Dir, float SizeRatio, uint32& OutIdAtDir, uint32& OutIdAtOppositeDir)", FUNC_TRIVIAL(ImGuiInternalWrappers::DockBuilderSplitNode));
